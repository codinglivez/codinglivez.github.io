...
scene.set({
  ...
  "[data-typing='frontend']": {
    1: Scene.typing({ text: "Wish you", duration: 1}),
  },
  "[data-typing='engineer']": {
    1.5: Scene.typing({ text: "Happy", duration: 1}),
  },
  "[data-typing='with']": {
    3.3: Scene.typing({ text: " Friendship", duration: 0.5}),
  },
  "[data-typing='javascript']": {
    4.5: Scene.typing({ text: " Day", duration: 1}),
  },
  "[data-typing='typescript']": {
    6: Scene.typing({ text: "Live your", duration: 1}),
  },
  "[data-typing='css']": {
    7.5: Scene.typing({ text: "Life", duration: 0.7}),
  },
  "[data-typing='nodejs']": {
    9: Scene.typing({ text: "Happily &", duration: 1}),
  },
  "[data-typing='animation']": {
    10.5: Scene.typing({ text: "Prosperously", duration: 1}),
  },
  "[data-typing='scenejs']": {
    12: Scene.typing({ text: "🥳🥳", duration: 1}),
  },
});
